import { __commonJSMin, __toESM, getHot } from "./hot-LFz3raSo.js";
import { Fragment, computed, createBaseVNode, createBlock, createCommentVNode, createElementBlock, createTextVNode, createVNode, customRef, defineComponent, getCurrentInstance, h, inject, nextTick, normalizeClass, normalizeStyle, onBeforeUnmount, onMounted, openBlock, provide, ref, renderList, renderSlot, resolveComponent, resolveDynamicComponent, toDisplayString, toRefs, toValue, unref, useSlots, useTemplateRef, watch, watchEffect, withAsyncContext, withCtx, withDirectives } from "./runtime-core.esm-bundler-De4U-ag6.js";
import { useRoute, useRouter, vShow } from "./vue-router-BQnQzYAn.js";
import { guessMode, inspectSourcemaps, isStaticMode, onModuleUpdated, rpc, safeJsonParse, tryOnScopeDispose, usePayloadStore } from "./payload-D299S_JB.js";
import "./_plugin-vue_export-helper-DfavQbjy.js";
import { Badge_default, Container_default, NavBar_default, PluginName_default, QuerySelector_default } from "./QuerySelector-7gsQ221k.js";
import { DurationDisplay_default, useOptionsStore } from "./options-hYqd54Os.js";
import { ModuleId_default, ModuleList_default, kt } from "./ModuleList-CFbx1RRF.js";
const Pe = {
	__name: "splitpanes",
	props: {
		horizontal: {
