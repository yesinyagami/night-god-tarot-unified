    ...
    <nav class="container mx-auto px-4 py-4">
      <div class="flex items-center justify-between">
        ...
        <router-link to="/" class="flex items-center gap-3 group">
          <div class="w-10 h-10 bg-gradient-to-br from-gold-400 to-purple-600 rounded-full flex items-center justify-center text-xl font-bold text-black group-hover:scale-110 transition-transform">
            🌙
          </div>
          <div>
